...
import { LOCALSTORAGE_COMPANY_ID, LOCALSTORAGE_SYSTEM_USER_ID, LOCALSTORAGE_USER_ID, createSession, getLocalStorageItem, getSessionById, setLocalStorageItem } from '../../services/api/sessionService';
    ...
    const handleSignup = async () => {
        try {
            ...
            const defaultCompany = {
                ...
                token: '', // This will be generated by the backend
                api_keys: [
            ...
            debugger;
            const companyId = await rootStore.addCompany(defaultCompany as ICompany);
