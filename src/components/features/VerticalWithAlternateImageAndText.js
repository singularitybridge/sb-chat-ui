    ...
    <Container>
      ...
      <SingleColumn>
        <HeadingInfoContainer>
          <HeadingTitle>Support and Strategies</HeadingTitle>
          <HeadingDescription>
            Support, understanding and practical advice for parents
          </HeadingDescription>
        </HeadingInfoContainer>
        ...
        <Content>
          {stories.map((card, i) => (
            ...
            <Image imageSrc={card?.image[0]?.url}/>
              <Details>                
                <Title>{card.title}</Title>
                <Description>{card.intro}</Description>
